 ...
 *
 */
package com.hunchee.dreamcode.server.guice;

import com.google.inject.AbstractModule;
import com.google.inject.Scopes;
import com.google.inject.name.Names;
import com.hunchee.dreamcode.server.services.*;
import com.hunchee.dreamcode.server.services.gae.*;
...
public class GuiceConfigModule extends AbstractModule {
    ...
    protected Properties readProperties(){
        if(context != null){
            InputStream is =  context.getClass().getResourceAsStream("/dreamcode.properties");
