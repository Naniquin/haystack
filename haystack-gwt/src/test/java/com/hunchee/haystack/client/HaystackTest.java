...
public class HaystackTest extends GWTTestCase {

    private static String URL_BASE = "http://localhost:8080";

    @Override
    public String getModuleName() {
        return "com.hunchee.haystack.haystack";
    }
    @Override
    ...
    public void testRequestBuilder(){
        ...
        String type = "test";
        String id = "1";
        //String url = URL_BASE + Routes.haystack_API + Routes.PUBLIC_STORE_API + "?type=" + type + "&id=" + id;
        String url = URL_BASE;
    ...
    public void testGlobalStoreAdd(){
        String url = URL_BASE; //Routes.haystack_API + Routes.PUBLIC_STORE_API
